...
attach(ConcOaxaca) #this is for not writing the name of the data frame and the $ ever time

#Sort Conc according to INGCOR, FOLIOVIV, FOLIOHOG
ConcOaxaca<- orderBy (~+ing_cor+folioviv+foliohog, data=ConcOaxaca) #this give us the households sorted by total income

#Adding the values of the expansion FACTOR. The sum is 34 million, which is the number of households in the country.
tot_hogares<-sum(ConcOaxaca$factor,to.data.frame=TRUE)
...
ConcOaxaca$tam_dec<-tam_dec

# Creating Deciles of Income 

ConcOaxaca$MAXT<-ConcOaxaca$ing_cor #vamos a crear en esta base la variable MAXT que es una copia de la columna de ingresos

ConcOaxaca<-ConcOaxaca[with(ConcOaxaca, order(rank(MAXT))),]  #lo que hicimos aqu? fue reordenar la base con respecto a MAXT. Cosa que en realidad, ya estaba.

ConcOaxaca$ACUMULA<-cumsum(ConcOaxaca$factor) #aqu? creamos una variable de suma acumulada del FACTOR de viviendas.
...
for(i in 1:9)
{
  a1<-ConcOaxaca[dim(ConcOaxaca[ConcOaxaca$ACUMULA<tam_dec*i,])[1]+1,]$factor
  ConcOaxaca<-rbind(ConcOaxaca[1:(dim(ConcOaxaca[ConcOaxaca$ACUMULA<tam_dec*i,])[1]+1),],
                        ConcOaxaca[(dim(ConcOaxaca[ConcOaxaca$ACUMULA<tam_dec*i,])[1]+1):dim(ConcOaxaca[1])[1],])
  
  b1<-tam_dec*i-ConcOaxaca[dim(ConcOaxaca[ConcOaxaca$ACUMULA<tam_dec*i,])[1],]$ACUMULA
  ConcOaxaca[(dim(ConcOaxaca[ConcOaxaca$ACUMULA<tam_dec*i,])[1]+1),]$factor<-b1
  ConcOaxaca[(dim(ConcOaxaca[ConcOaxaca$ACUMULA<tam_dec*i,])[1]+2),]$factor<-(a1-b1)
}

#aqu? estamos creando otra variable de suma acumulada del n?mero de hogares
ConcOaxaca$ACUMULA2<-cumsum(ConcOaxaca$factor)
...
ConcOaxaca[(ConcOaxaca$ACUMULA2<=tam_dec),]$DECIL<-1
...
for(i in 1:9)
{
  ConcOaxaca[((ConcOaxaca$ACUMULA2>tam_dec*i)&(ConcOaxaca$ACUMULA2<=tam_dec*(i+1))),]$DECIL<-(i+1)
}

# a lo que le qued? cero (que es la ?ltima observaci?n), ponle el decil 10
ConcOaxaca[ConcOaxaca$DECIL%in%"0",]$DECIL<-10

setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Oaxaca")
write.dbf(ConcOaxaca,file="ConcOaxaca2010.dbf")
...
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Oaxaca")
write.dbf(ConcOaxaca,file="ConcOaxaca2018.dbf")
...
#reading the data
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Oaxaca")
Conc2010<-read.dbf("ConcOaxaca2010.dbf",as.is = T)
...
write.dbf(c_DECIL_ES,file = "Oaxaca por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "Oaxaca por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "Oaxaca por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "Oaxaca por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "Oaxaca por fuente por DECIL LS 2010.dbf")
...
write.dbf(c_DECIL_ES,file = "Oaxaca INDIGENA por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "Oaxaca INDIGENA por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "Oaxaca INDIGENA por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "Oaxaca INDIGENA por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "Oaxaca INDIGENA por fuente por DECIL LS 2010.dbf")
...
write.dbf(c_DECIL_ES,file = "Oaxaca NO por fuente por DECIL estimaciones 2010.dbf")
write.dbf(c_DECIL_SE,file = "Oaxaca NO por fuente por DECIL errores standard 2010.dbf")
write.dbf(c_DECIL_CV,file = "Oaxaca NO por fuente por DECIL CV 2010.dbf")
write.dbf(c_DECIL_LI,file = "Oaxaca NO por fuente por DECIL LI 2010.dbf")
write.dbf(c_DECIL_ES,file = "Oaxaca NO por fuente por DECIL LS 2010.dbf")
...
#reading the data
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/Oaxaca")
Conc2018<-read.dbf("ConcOaxaca2018.dbf",as.is = T)
...
write.dbf(c_DECIL_ES,file = "Oaxaca Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "Oaxaca Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "Oaxaca Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "Oaxaca Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "Oaxaca Ingresos por fuente por DECIL LS 2018.dbf")
...
write.dbf(c_DECIL_ES,file = "Oaxaca INDIGENA Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "Oaxaca INDIGENA Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "Oaxaca INDIGENA Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "Oaxaca INDIGENA Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "Oaxaca INDIGENA Ingresos por fuente por DECIL LS 2018.dbf")
...
write.dbf(c_DECIL_ES,file = "Oaxaca NO Ingresos por fuente por DECIL estimaciones 2018.dbf")
write.dbf(c_DECIL_SE,file = "Oaxaca NO Ingresos por fuente por DECIL errores standard 2018.dbf")
write.dbf(c_DECIL_CV,file = "Oaxaca NO Ingresos por fuente por DECIL CV 2018.dbf")
write.dbf(c_DECIL_LI,file = "Oaxaca NO Ingresos por fuente por DECIL LI 2018.dbf")
write.dbf(c_DECIL_ES,file = "Oaxaca NO Ingresos por fuente por DECIL LS 2018.dbf")
...
Deciles2010<-read.dbf("Oaxaca por fuente por DECIL estimaciones 2010.dbf")
names(Deciles2010)[1]<-c("ingcor2010")

Deciles2018<-read.dbf("Oaxaca Ingresos por fuente por DECIL estimaciones 2018.dbf")
...
deciles2010No<-read.dbf("Oaxaca NO por fuente por DECIL estimaciones 2010.dbf")
names(deciles2010No)[1]<-c("No2010")

deciles2018No<-read.dbf("Oaxaca NO Ingresos por fuente por DECIL estimaciones 2018.dbf")
...
deciles2010indigena<-read.dbf("Oaxaca INDIGENA por fuente por DECIL estimaciones 2010.dbf")
names(deciles2010indigena)[1]<-c("Indigena2010")

deciles2018indigena<-read.dbf("Oaxaca INDIGENA Ingresos por fuente por DECIL estimaciones 2018.dbf")
